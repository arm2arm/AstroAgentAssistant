...
metadata:
  hermes:
    ...
    related_skills: [python-mcp-docs-first, dask-mcp-docs-first, dask-hvplot-datashader-scientific-plots, hdf5-on-s3-cached, docs-mcp-at-aip, mcporter, native-mcp]
---
